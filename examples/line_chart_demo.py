...
def make_sin_data(offset=0):
    data = []
    for x in range(0, 100):
        data.append((x / 10.0, math.sin(x / 10.0) + offset))
    return data
...
grapha = line_chart.Graph("sin", "Sine", make_sin_data(4))
...
vbox_graph = graph_options.GraphControl([grapha, graphb, graphc])
